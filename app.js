...
async function fetchSinglePost() {
    ...
    try {
        ...
        if (post.youtubeUrl?.includes('embed')) {
            html += `
                <div class="video-container" style="margin-top: 40px; position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 12px;">
                    <iframe src="${post.youtubeUrl}" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border:0;" allowfullscreen></iframe>
                </div>
            `;
        }
